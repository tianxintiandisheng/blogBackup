---
title: vue-cli3的eslint配置问题
categories:
  - Vue
date: 2019-11-01 13:33:10
tags:
---
...
真实蛋疼eslint默认要4个空格的缩进啊
于是网上搜索了好多es-lint的配置方法，
...
文件为根目录下的 **package.json**文件（规则写在rules内）
格式：
...
# 参考资料
 ...
 [vue-cli下ESlint 配置说明](https://blog.csdn.net/M_wolf/article/details/79409557) 原创：[来自星星的马](https://blog.csdn.net/M_wolf)
 [ESLint在Vue中的使用详解](https://blog.csdn.net/IT_HLM/article/details/78776630)  原创：[老哥二娃](https://blog.csdn.net/IT_HLM)
