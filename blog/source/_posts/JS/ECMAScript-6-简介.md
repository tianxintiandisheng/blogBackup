...
1. [ECMAScript 和 JavaScript 的关系](#docs/intro#ECMAScript 和 JavaScript 的关系)
2. [ES6 与 ECMAScript 2015 的关系](#docs/intro#ES6 与 ECMAScript 2015 的关系)
3. [语法提案的批准流程](#docs/intro#语法提案的批准流程)
4. [ECMAScript 的历史](#docs/intro#ECMAScript 的历史)
5. [部署进度](#docs/intro#部署进度)
6. [Babel 转码器](#docs/intro#Babel 转码器)
7. [Traceur 转码器](#docs/intro#Traceur 转码器)
